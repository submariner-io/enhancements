...
7. When a cluster previously connected via submariner/federation is removed, any auxiliary resources, rules, or artifacts maintained by the submariner network policy implementation must be properly cleaned up.
